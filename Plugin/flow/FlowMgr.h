...
class CFlowMgr:public CScModuleBase {
	
public:
	CFlowMgr(const string &strConfigName);
	virtual ~CFlowMgr(void); 
...
public:
	tag_flow_config_t m_flowConfig;
